...
_Validated using: `skill-validator` skill — criteria from `references/detailed-criteria.md`, calibrated against `references/scoring-examples.md`_
_Validated: 2026-05-02_
